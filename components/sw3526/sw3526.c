...
void SW35xxInit(void){
    ...
    SW35xxWriteReg(SW35XX_FAST_CHARGE_CON3,0x04,SW_I2C_1);
    SW35xxWriteReg(SW35XX_PWR_CONF,0x01,SW_I2C_1);//设定功率限制为64W
    ...
    SW35xxWriteReg(SW35XX_FAST_CHARGE_CON3,0x04,SW_I2C_2);
    SW35xxWriteReg(SW35XX_PWR_CONF,0x01,SW_I2C_2);//设定功率限制为64W
...
void SW35xxAggreLimitPPS(int x)
{
    ...
    {
        sw_i2c_init(GPIO_NUM_7,GPIO_NUM_6,SW_I2C_1);
        SW35xxWriteReg(SW35XX_FAST_CHARGE_CON1,0xC0,SW_I2C_1);
        sw_i2c_init(GPIO_NUM_5,GPIO_NUM_6,SW_I2C_2);
        SW35xxWriteReg(SW35XX_FAST_CHARGE_CON1,0xC0,SW_I2C_2);
    }
    else
    {
        sw_i2c_init(GPIO_NUM_7,GPIO_NUM_6,SW_I2C_1);
        SW35xxWriteReg(SW35XX_FAST_CHARGE_CON1,0x00,SW_I2C_1);
        sw_i2c_init(GPIO_NUM_5,GPIO_NUM_6,SW_I2C_2);
        SW35xxWriteReg(SW35XX_FAST_CHARGE_CON1,0x00,SW_I2C_2);
    }
}
...
void SW35XXUpdate(void){
    ...
    sw35xx_c1.pdversion = (buf_1&0X30) >> 4;
    ...
    temperature = SW35xxReadReg(SW35XX_ADC_TS_H, SW_I2C_1) << 4;
    temperature |= SW35xxReadReg(SW35XX_ADC_TS_L, SW_I2C_1) & 0X0F;
    sw35xx_c1.tem = temperature * 0.5;
    ...
    sw35xx_c2.pdversion = (buf_1&0X30) >> 4;
    ...
    temperature = SW35xxReadReg(SW35XX_ADC_TS_H, SW_I2C_2) << 4;
    temperature |= SW35xxReadReg(SW35XX_ADC_TS_L, SW_I2C_2) & 0X0F;
    sw35xx_c2.tem = temperature * 0.5;
