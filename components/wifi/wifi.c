...
#define EXAMPLE_ESP_WIFI_SSID      "yds_charger"
#define EXAMPLE_ESP_WIFI_PASS      "password"
#define EXAMPLE_ESP_WIFI_CHANNEL   1
#define EXAMPLE_MAX_STA_CONN       4
#define EXAMPLE_ESP_MAXIMUM_RETRY  5
#define WIFI_EVENT_STA_CONFIGURE 0x1001
...
uint8_t wifi_init_sta(uint8_t mode)
{
    ...
    else
    {
        ...
        esp_wifi_start();
        esp_event_post(WIFI_EVENT, WIFI_EVENT_STA_CONFIGURE, NULL, 0, portMAX_DELAY);//开始配网
        bits = xEventGroupWaitBits(s_wifi_event_group,
                                   pdFALSE,
                                   pdFALSE,
                                   portMAX_DELAY);
                                ...
                                int32_t event_id, void* event_data)
{
    ...
    else if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_CONFIGURE) {
        start_wifi_config();
    }
}
